...
func _build_checks() -> void:
	...
	check_mouse_projection_is_ok.description = tr("The mouse calculations are accurate.")


	var check_mouse_position := Check.new()
	check_mouse_position.description = tr("The mouse position variable stores the mouse cursor's position.")
